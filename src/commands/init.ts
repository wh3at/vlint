...
import type { ConfigV3, DeviceProfile, Viewport } from "../contracts/config";
import {
  boundaryFailure,
  boundarySuccess,
  type BoundaryResult,
...
/**
 * Build the standard version 3 config: the two standard devices and rules, with
 ...
 */
export function buildStandardConfig(source: DeviceSource = playwrightDevices): BoundaryResult<ConfigV3> {
